...
from RemoveRole2_GG_rule import *
from RemoveAgent2_GG_rule import *
class Omacs2Pns_GG_exec (GraphGrammar):
   def __init__ (self, parent):
      GraphGrammar.__init__(self, [Agent2RoleLink1_GG_rule(parent) , Agent2RoleLink2_GG_rule(parent) , Agent2RoleLink3_GG_rule(parent) , CollectInf1_GG_rule(parent) , CollectInf2_GG_rule(parent) , CollectInf3_GG_rule(parent) , TransAgent2Raw_GG_rule(parent) , TransLinkAR2OpUnit_GG_rule(parent) , TransGoal2Mat_GG_rule(parent) , CreatLinkRaw2AR_GG_rule(parent) , CreateFinalStat_GG_rule(parent) , CreateLinkMatr2OAF_GG_rule(parent) , CreateMat_ARG_GG_rule(parent) , CreateLinkMat_ARG2Goal_GG_rule(parent) , CreateLinkAR2Mat_GG_rule(parent) , AssignPrice4Raw_GG_rule(parent) , AssignCost4AR_GG_rule(parent) , RemoveGoal_GG_rule(parent) , RemoveAgent_GG_rule(parent) , RemoveCap_GG_rule(parent) , RemoveRole_GG_rule(parent) , RemoveRole2_GG_rule(parent) , RemoveAgent2_GG_rule(parent)])
