"""
__graph_achieve.py___________________________________________________________

Automatically generated LINK for entity achieve
...
class graph_achieve(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('achieve_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('achieve_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('achieve_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('achieve_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('achieve_2ndLink', self.le.SecondLink))
