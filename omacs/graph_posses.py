"""
__graph_posses.py___________________________________________________________

Automatically generated LINK for entity posses
...
class graph_posses(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('posses_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('posses_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('posses_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('posses_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('posses_2ndLink', self.le.SecondLink))
