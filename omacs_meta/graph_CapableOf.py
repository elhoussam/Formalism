"""
__graph_CapableOf.py___________________________________________________________

Automatically generated LINK for entity CapableOf
...
class graph_CapableOf(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('CapableOf_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('CapableOf_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('CapableOf_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('CapableOf_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('CapableOf_2ndLink', self.le.SecondLink))
