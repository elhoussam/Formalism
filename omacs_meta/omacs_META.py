...
Author: USER
Modified: Wed Apr 26 11:29:33 2017
...
def omacs_META(self, rootNode, ButtonsRootNode=None):
    ...
    self.obj21.Contents.Image.setValue('omacs_meta/icons/btnE.gif')
    ...
    self.obj22.Contents.Image.setValue('omacs_meta/icons/btnH.gif')
    ...
    # Contents
    self.obj23.Contents.Text.setValue('New Agent')
    self.obj23.Contents.Image.setValue('omacs_meta/icons/btnA2.gif')
    ...
    # Contents
    self.obj24.Contents.Text.setValue('New Capabilitie')
    self.obj24.Contents.Image.setValue('omacs_meta/icons/cc.gif')
    self.obj24.Contents.lastSelected= "Image"

    self.obj24.graphClass_= graph_ButtonConfig
    if self.genGraphics:
       new_obj = graph_ButtonConfig(140.0,0.0,self.obj24)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("ButtonConfig", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # Contents
    self.obj25.Contents.Text.setValue('New Role')
    self.obj25.Contents.Image.setValue('omacs_meta/icons/btnR2.gif')
    self.obj25.Contents.lastSelected= "Image"

    self.obj25.graphClass_= graph_ButtonConfig
    if self.genGraphics:
       new_obj = graph_ButtonConfig(300.0,80.0,self.obj25)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("ButtonConfig", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # Contents
    self.obj26.Contents.Text.setValue('New Goal')
    self.obj26.Contents.Image.setValue('omacs_meta/icons/btnG2.gif')
    self.obj26.Contents.lastSelected= "Image"

    self.obj26.graphClass_= graph_ButtonConfig
    if self.genGraphics:
       new_obj = graph_ButtonConfig(120.0,200.0,self.obj26)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("ButtonConfig", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
