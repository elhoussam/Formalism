"""
__FromRaw.py_____________________________________________________
...
class FromRaw(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_FromRaw
   ...
   def clone(self):
      cloneObject = FromRaw( self.parent )
