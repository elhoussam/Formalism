"""
__graph_FromRaw.py___________________________________________________________

Automatically generated LINK for entity FromRaw
...
class graph_FromRaw(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('FromRaw_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('FromRaw_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('FromRaw_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('FromRaw_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('FromRaw_2ndLink', self.le.SecondLink))
