...
class graph_fromMaterial_Center(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([28.0, 10.0, 28.0, -94.0])[:2], tags = self.tag, font=font, fill = 'magenta4', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
