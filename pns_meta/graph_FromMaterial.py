"""
__graph_FromMaterial.py___________________________________________________________

Automatically generated LINK for entity FromMaterial
...
class graph_FromMaterial(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('FromMaterial_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('FromMaterial_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('FromMaterial_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('FromMaterial_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('FromMaterial_2ndLink', self.le.SecondLink))
