"""
__intoMaterial.py_____________________________________________________
...
class intoMaterial(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_intoMaterial
   ...
   def clone(self):
      cloneObject = intoMaterial( self.parent )
