...
class graph_FromRaw_Center(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([25.0, 15.0, 25.0, 12.0])[:2], tags = self.tag, font=font, fill = 'green', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
