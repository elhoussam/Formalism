"""
__FromMaterial.py_____________________________________________________
...
class FromMaterial(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_FromMaterial
   ...
   def clone(self):
      cloneObject = FromMaterial( self.parent )
