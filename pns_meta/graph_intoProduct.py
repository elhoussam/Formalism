"""
__graph_intoProduct.py___________________________________________________________

Automatically generated LINK for entity intoProduct
...
class graph_intoProduct(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('intoProduct_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('intoProduct_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('intoProduct_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('intoProduct_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('intoProduct_2ndLink', self.le.SecondLink))
