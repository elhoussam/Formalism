...
class graph_operatingUnit(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_oval(self.translate([19.0, 8.0, 19.0, 8.0]), tags = (self.tag, 'connector'), outline = '', fill = '' )
        self.connectors.append( h )

        h = drawing.create_oval(self.translate([53.0, 8.0, 53.0, 8.0]), tags = (self.tag, 'connector'), outline = '', fill = '' )
        self.connectors.append( h )

        h = drawing.create_oval(self.translate([50.0, 1.0, 50.0, 1.0]), tags = (self.tag, 'connector'), outline = '', fill = '' )
        self.connectors.append( h )

        h = drawing.create_oval(self.translate([20.0, 1.0, 20.0, 1.0]), tags = (self.tag, 'connector'), outline = '', fill = '' )
        self.connectors.append( h )

        h = drawing.create_rectangle(self.translate([0.0, 0.0, 74.0, 9.0]), tags = self.tag, stipple = '', width = 1, outline = '', fill = 'black')
        ...
        h = drawing.create_text(self.translate([120.0, 0.0, 120.0, -5.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
