...
\begin{figure}[th]
	\centering
		\includegraphics[0.5]{Chapiter3/img/Pyramid}
...
\begin{figure}[th]
	\centering
		\includegraphics[scale=0.9]{Chapiter3/img/rules}
...
\begin{figure}[th]
	\centering
		\includegraphics[scale=0.4]{Chapiter3/img/systemTran}
...
\begin{figure}[th]
\centering
	\subfloat[LHS]{\includegraphics[scale=0.9]{Chapiter3/img/L1}}
		\quad{}
		\includegraphics{Chapiter3/img/sep}
		\quad{}
	\subfloat[RHS]{\includegraphics[scale=0.9]{Chapiter3/img/R1}}
\caption{\label{fig:Create link between Agent and Role}Assign Role to Agent } 
\end{figure}
 

\paragraph{\emph{2)~Transform Agent to Raw Material (order 5) :} }
...
\begin{figure}[th]
\centering
	\subfloat[LHS]{\includegraphics[scale=0.9]{Chapiter3/img/L2}}
	\quad{}
		\includegraphics{Chapiter3/img/sep}
	\quad{}
	\subfloat[RHS]{\includegraphics[scale=0.9]{Chapiter3/img/R2}}
\caption{\label{fig:Generate for each agent raw material}Transform Agent to Raw-material} 
\end{figure}
\vspace{1cm}

%% ------------------------------------------------------------------------------------------------ order 7 
\paragraph{\emph{3)~Transform Link between Agent and Role into Operating Unit (order 7) :} } This rule (Figure \ref{fig:Operating Unit for every link capable of playing}) allow to transform , the relation capable of playing between an agent and role  into operating unit .
\vspace{1cm}
\begin{figure}[th]
	\centering
	\subfloat[LHS]{\includegraphics[scale=0.9]{Chapiter3/img/L3}}
	\quad{}
		\includegraphics{Chapiter3/img/sep}
	\quad{}
	\subfloat[RHS]{\includegraphics[scale=0.9]{Chapiter3/img/R3}}
...
\begin{figure}[th]
\centering 
	\subfloat[LHS]{\includegraphics[scale=0.9]{Chapiter3/img/L4}}
	\quad{}
		\includegraphics{Chapiter3/img/sep}
	\quad{}
	\subfloat[RHS]{\includegraphics[scale=0.9]{Chapiter3/img/R4}}
...
\begin{figure}[th]
\centering
	\subfloat[LHS]{\includegraphics[scale=1.2]{Chapiter3/img/empty_LHS}}% l5
	\quad{}
		\includegraphics{Chapiter3/img/sep}
	\quad{}
	\subfloat[RHS]{\includegraphics[scale=0.9]{Chapiter3/img/R5}}
...
\begin{figure}[th]
\centering 
	\subfloat[LHS]{\includegraphics[scale=0.9]{Chapiter3/img/L6}}
	\quad{}
		\includegraphics{Chapiter3/img/sep}
	\quad{}
	\subfloat[RHS]{\includegraphics[scale=0.9]{Chapiter3/img/R6}}
...
\begin{figure}[th]
\centering 
	\subfloat[LHS]{\includegraphics[scale=0.9]{Chapiter3/img/L7}}
	\quad{}
		\includegraphics{Chapiter3/img/sep}
	\quad{}
	\subfloat[RHS]{\includegraphics[scale=0.9]{Chapiter3/img/R7}}
...
\centering
	...
	\subfloat[LHS]{\includegraphics[scale=2.2]{Chapiter3/img/L8}}
	\quad{}\quad{}
		\includegraphics{Chapiter3/img/sep}
	\quad{}\quad{}
	\subfloat[LHS]{\includegraphics[scale=2.2]{Chapiter3/img/R8}}
...
\begin{figure}[th]
\centering
 	\subfloat[LHS]{\includegraphics[scale=2.9]{Chapiter3/img/L9}}
		\quad{}\quad{}
			\includegraphics{Chapiter3/img/sep}
	\quad{}\quad{}
	\subfloat[LHS]{\includegraphics[scale=2.2]{Chapiter3/img/R9}}
...
Now it's supposed to be aware every rule has a condition must be true  before the engine run this rule , i mention some these condition in the next part . \paragraph{\emph{1)~Condition for the rule   Assign Role to Agent  :  } } 
...
\subfloat[LHS]{\includegraphics[scale=0.5]{Chapiter3/img/xL1}}
\quad{}
\includegraphics{Chapiter3/img/sep}
\quad{}
\subfloat[RHS]{\includegraphics[scale=0.5]{Chapiter3/img/xR1}}
...
\begin{figure}[th]
\centering
 \subfloat[LHS]{\includegraphics[scale=1.3]{Chapiter3/img/xL2}}
 \quad{} \quad{}
\includegraphics{Chapiter3/img/sep}
\quad{} \quad{}
\subfloat[RHS]{\includegraphics[scale=1.3]{Chapiter3/img/xR2}}
