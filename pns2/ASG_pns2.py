"""
__ASG_pns2.py_____________________________________________________
...
class ASG_pns2(ASG, ATOM3Type):

   def __init__(self, parent= None, ASGroot = None):
      ASG.__init__(self, 'pns2', ASGroot, ['ASG_pns2' ,'rawMaterial' ,'product' ,'metarial' ,'operatingUnit' ,'fromRaw' ,'intoMaterial' ,'intoProduct' ,'fromMaterial'])
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'pns2', 0, 1, self)
