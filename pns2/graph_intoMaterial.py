"""
__graph_intoMaterial.py___________________________________________________________

Automatically generated LINK for entity intoMaterial
...
class graph_intoMaterial(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('intoMaterial_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('intoMaterial_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('intoMaterial_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('intoMaterial_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('intoMaterial_2ndLink', self.le.SecondLink))
