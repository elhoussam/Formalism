...
class graph_product(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        self.image_gf16 = PhotoImage(format='gif',data=self.imageDict['p.gif' ])
        h = drawing.create_image(self.translate([25.0, 25.0]), tags = self.tag, image = self.image_gf16)
        self.gf16 = GraphicalForm(drawing, h, 'gf16', 'p.gif')
        ...
        h = drawing.create_text(self.translate([26.0, 52.0, 26.0, 38.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
        self.attr_display["Name"] = h
        self.gf19 = GraphicalForm(drawing, h, 'gf19', fontObject=font)
