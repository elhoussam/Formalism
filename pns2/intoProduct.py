"""
__intoProduct.py_____________________________________________________
...
class intoProduct(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_intoProduct
   ...
   def clone(self):
      cloneObject = intoProduct( self.parent )
